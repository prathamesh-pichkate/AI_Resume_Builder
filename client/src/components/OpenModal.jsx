...
const OpenModal = ({
  ...
  const handleSubmit = () => {
    ...
    if (mode === "upload" && !file) return alert("Please upload a PDF file.");
        ...
        >
          ...
          <div className="flex items-center w-full md:px-4">
            ...
            <button
              ...
              className="font-medium text-sm text-white bg-pink-500 w-36 h-10 rounded-r-md hover:bg-pink-600 transition"
            >
              {button}
            </button>
          </div>
