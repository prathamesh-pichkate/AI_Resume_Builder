...
export default function Navbar() {
  ...
  // 👉 Replace this with actual authentication logic (e.g., from context or localStorage)
  const [isLoggedIn, setIsLoggedIn] = useState(false);

  const handleLogout = () => {
    // Example: remove token or clear session
  ...
  return (
    <>
      ...
      {/* ✅ Mobile menu (only for not logged in users) */}
      {!isLoggedIn && (
        <div
