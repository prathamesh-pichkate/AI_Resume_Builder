...
const DashboardHeroSection = ({ userName = "Prathamesh Pichkate" }) => {
  const [createResumeModalOpen, setCreateResumeModalOpen] =
    React.useState(false);
  const [uploadResumeModalOpen, setUploadResumeModalOpen] =
    React.useState(false);
